...
// DeepSeek V4 Pro, by the founder's explicit and repeated instruction. Repair
// work is the one place the model is a settled decision rather than a default,
// so do not swap it for whatever is cheapest or newest. The env override exists
// for an incident where DeepSeek itself is the thing that is down.
