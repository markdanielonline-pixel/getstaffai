 ...
 *
 * The model names and fallback chains below never execute. They are not a model
 * policy; STATE.md records what actually runs. Repair work is DeepSeek V4 Pro by
 * standing instruction, and none of the chains here have any bearing on that.
 */
// ════════════════════════════════════════════════════════════════════
