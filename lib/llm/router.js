...
const MODELS = {
  ...
  deepseek_r1: 'deepseek/deepseek-reasoner-v3-1217',
  grok4: 'grok-4',
...
export async function callLLM(req) {
  ...
  try {
    ...
    const chain = req.level === 'prestige'
      ? [() => callXAI(MODELS.grok4, req.system, req.messages), () => callOpenRouter(MODELS.deepseek_r1, req.system, req.messages), () => callOpenRouter(MODELS.deepseek_v3, req.system, req.messages), () => callOpenRouter(MODELS.openrouter_reliable, req.system, req.messages), () => callOpenRouter(MODELS.openrouter_free, req.system, req.messages)]
      : req.level === 'executive'
      ? [() => callOpenRouter(MODELS.deepseek_r1, req.system, req.messages), () => callOpenRouter(MODELS.deepseek_v3, req.system, req.messages), () => callOpenRouter(MODELS.openrouter_reliable, req.system, req.messages), () => callOpenRouter(MODELS.openrouter_free, req.system, req.messages)]
      : [() => callOpenRouter(MODELS.deepseek_r1, req.system, req.messages), () => callOpenRouter(MODELS.openrouter_reliable, req.system, req.messages), () => callOpenRouter(MODELS.openrouter_free, req.system, req.messages)];
